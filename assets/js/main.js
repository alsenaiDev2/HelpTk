...
document.querySelector("#profile-icon").addEventListener("click", () => {
  var lang = localStorage.getItem("lang") || "ar";
  if (lang == "ar") {
    document.querySelector("#profile-dropdown").style.transform =
      "translate(16px, 54px)";
  }
})
...
window.addEventListener("click", function (e) {
  if (
    ...
    document.querySelector(".toggle-sidebar-btn").contains(e.target)
  ) {
  } else {
